...
export const pt_BR: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Rascunho",
    draftDescription: "Mantenha esta conversa apenas para você até publicá-la",
  ...
  dashboardsPage: {
    ...
    emptyDescription: "Abra uma conversa e alterne para a face de Dashboard para adicioná-la aqui.",
  ...
  agents: {
    ...
    files: {
      ...
      createHint: "Este arquivo ainda não existe. Salvar irá criá-lo no workspace do agente.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  subtitles: {
    ...
    dashboards: "Conversas que abrem em sua face de dashboard.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Motor",
      description:
        "Exatamente um plugin de memória detém o slot de memória. Selecionar um motor o ativa e desativa os demais.",
      rowTitle: "Motor de memória",
      off: "Desativada",
      autoHint:
        "Nenhum motor está fixado na configuração, então o slot recorre ao seu proprietário padrão.",
      ...
      catalogUnavailable: "Conecte-se ao gateway para alterar o motor de memória.",
      changeFailed: "Não foi possível alterar o motor de memória",
    ...
    import: {
      title: "Importar",
      description: "Traga a memória existente de outros assistentes para um workspace de agente.",
    ...
    dreaming: {
      ...
      frequency: {
        label: "Frequência de sonho",
        help: "Cadência cron para a varredura completa de sonhos (leve, REM e, então, profunda). Deixe vazio para usar o padrão do plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Fuso horário",
      ...
      storage: {
        title: "Armazenamento",
        description: "Onde memórias promovidas e relatórios de sonhos são gravados.",
        modeLabel: "Modo de armazenamento",
        modeHelp:
          "Inline grava dentro do arquivo de memória; separado mantém um arquivo de relatório dedicado.",
        modes: {
          inline: "Inline",
          separate: "Separado",
          both: "Ambos",
        ...
        separateReportsHelp: "Mantém os relatórios de sonhos fora do arquivo de memória principal.",
      },
      phases: {
        light: {
          title: "Fase leve",
          description: "Passagem barata sobre a atividade recente que prepara candidatos a replay.",
        },
        deep: {
          title: "Fase profunda",
          description:
        ...
        rem: {
          title: "Fase REM",
          description:
            "Passagem de padrões que busca temas recorrentes ao longo da janela de retrospecção.",
        },
      },
      phaseFields: {
        enabled: "Ativado",
        enabledHelp: "Executar esta fase durante a varredura.",
        lookbackDays: "Dias de retrospecção",
        lookbackDaysHelp:
          "Até que ponto esta fase lê no passado. Deixe vazio para o padrão do plugin.",
        limit: "Limite",
        ...
        maxAgeDaysHelp: "Ignorar entradas de curto prazo mais antigas que isso.",
      ...
      unsupported: {
        ...
        description:
          "O plugin {plugin} controla o slot de memória e seu esquema de configuração não tem uma seção de sonho, portanto essas configurações não podem ser armazenadas. Altere o mecanismo na aba Visão geral para editá-las.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Mantenha um diretório de ferramentas limitado visível e adie o restante atrás da busca, para que catálogos grandes de MCP e plugins deixem de sobrecarregar o prompt.",
    },
    localModelLean: {
      title: "Ferramentas enxutas para modelos locais",
      description:
        "Remova ferramentas padrão pesadas que modelos locais menores lidam mal, deixando um conjunto mais curto que eles conseguem usar de forma confiável.",
    },
    auditMessages: {
      title: "Metadados de auditoria de mensagens",
      description:
        "Registre metadados sem conteúdo para conversas diretas no registro de auditoria. O conteúdo das mensagens nunca é armazenado.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "A varredura noturna de sonho será executada em cada workspace de agente configurado, promovendo recordações de curto prazo para a memória de longo prazo. Isso é aplicado imediatamente.",
      enableConfirm: "Ativar Sonho",
      disableTitle: "Desativar Sonho para Todos os Agentes",
      disableDetail:
        "A varredura noturna de sonho será interrompida para cada agente configurado, não apenas este. As memórias já gravadas permanecem; nada novo é promovido. Isso é aplicado imediatamente.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Ainda há resultados de pesquisa. Use um prefixo de id mais longo.",
    },
    sessionSharing: {
