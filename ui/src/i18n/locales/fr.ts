...
export const fr: TranslationMap = {
  ...
  agents: {
    ...
    files: {
      ...
      createHint:
        "Ce fichier n'existe pas encore. L'enregistrer le créera dans l'espace de travail de l'agent.",
      content: "Content",
      words: "{count} words",
      lines: "lines",
    },
  ...
  subtitles: {
    ...
    dashboards: "Fils qui s'ouvrent sur leur face de tableau de bord.",
  ...
  memoryPage: {
    ...
    engine: {
      ...
      catalogUnavailable: "Connectez-vous au gateway pour changer le moteur de mémoire.",
      changeFailed: "Impossible de changer le moteur de mémoire",
      disabledTitle: "Ce moteur est désactivé",
      disabledHint:
        "L'emplacement de mémoire pointe vers ce plugin, mais le plugin lui-même est désactivé, donc la mémoire n'est pas active.",
      enable: "Activer",
    },
    backend: {
      title: "Backend",
    ...
    addons: {
      ...
      description:
        "Ces plugins se superposent au moteur au lieu de se disputer l'emplacement, donc n'importe quelle combinaison peut fonctionner simultanément.",
      activeMemory: {
    ...
    search: {
      intro:
        "Valeurs par défaut d'intégration et de récupération partagées par tous les agents qui n'ont pas de remplacement de mémoire.",
    },
    dreaming: {
      intro:
        "Le rêve s'exécute comme une seule tâche cron gérée sur tous les espaces de travail d'agent, donc ces paramètres sont globaux. Ils sont détenus par le plugin {plugin}.",
      schedule: {
        title: "Planification",
      ...
      frequency: {
        ...
        help: "Cadence cron pour le balayage de rêve complet (léger, REM, puis profond). Laissez vide pour la valeur par défaut du plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
      ...
      model: {
        ...
        help: "Remplacement de fournisseur/modèle pour la narration du journal de rêves. Nécessite que les remplacements de modèle de sous-agent soient autorisés.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Journalisation détaillée",
        help: "Journaliser chaque phase de rêve en détail. Utile lors du réglage des seuils.",
      },
      storage: {
        title: "Stockage",
        description: "Où sont écrits les souvenirs promus et les rapports de rêve.",
        modeLabel: "Mode de stockage",
        modeHelp:
          "Inline écrit dans le fichier de mémoire ; séparé conserve un fichier de rapport dédié.",
        modes: {
          inline: "Inline",
          separate: "Séparé",
          both: "Les deux",
        ...
        separateReportsHelp: "Conserver les rapports de rêve hors du fichier de mémoire principal.",
      },
      phases: {
        light: {
          title: "Phase légère",
        ...
        rem: {
          title: "Phase REM",
          description:
            "Passe de motifs qui recherche les thèmes récurrents sur la fenêtre d'analyse rétrospective.",
        },
      },
      phaseFields: {
        enabled: "Activé",
        ...
        lookbackDaysHelp:
          "Jusqu'où cette phase remonte dans le temps. Laisser vide pour la valeur par défaut du plugin.",
        limit: "Limite",
        ...
        minRecallCount: "Rappels minimaux",
        minRecallCountHelp:
          "Combien de fois une entrée doit être rappelée avant de pouvoir être promue.",
        minUniqueQueries: "Requêtes uniques minimales",
        minUniqueQueriesHelp:
          "Combien de requêtes distinctes doivent avoir fait apparaître l'entrée.",
        recencyHalfLifeDays: "Demi-vie de récence (jours)",
        recencyHalfLifeDaysHelp:
          "Vitesse à laquelle les signaux de rappel plus anciens perdent de leur poids.",
        maxAgeDays: "Âge maximal (jours)",
        maxAgeDaysHelp: "Ignorer les entrées à court terme plus anciennes que cette valeur.",
        maxPromotedSnippetTokens: "Jetons max des extraits promus",
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Garde visible un répertoire d'outils limité et diffère le reste derrière la recherche, afin que les grands catalogues MCP et de plugins n'encombrent plus le prompt.",
    },
    localModelLean: {
      title: "Outils allégés pour les modèles locaux",
      description:
        "Supprime les outils par défaut lourds que les modèles locaux plus petits gèrent mal, laissant un ensemble plus court qu'ils peuvent utiliser de manière fiable.",
    },
    auditMessages: {
      title: "Métadonnées d'audit des messages",
      description:
        "Enregistre des métadonnées sans contenu pour les conversations directes dans le registre d'audit. Le contenu des messages n'est jamais stocké.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Le balayage nocturne du rêve s'exécutera sur chaque espace de travail d'agent configuré, promouvant les rappels à court terme en mémoire à long terme. Cela s'applique immédiatement.",
      enableConfirm: "Activer le rêve",
      disableTitle: "Désactiver le rêve pour tous les agents",
      disableDetail:
        "Le balayage nocturne du rêve s'arrêtera pour chaque agent configuré, pas seulement celui-ci. Les souvenirs déjà écrits sont conservés ; rien de nouveau n'est promu. Cela s'applique immédiatement.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches:
        "D'autres résultats de recherche subsistent. Utilisez un préfixe d'id plus long.",
    },
    sessionSharing: {
