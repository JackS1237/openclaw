...
export const pl: TranslationMap = {
  ...
  dashboardsPage: {
    ...
    loadError: "Nie udało się załadować pulpitów: {error}",
  },
  sessionsView: {
  ...
  subtitles: {
    ...
    dashboards: "Wątki, które otwierają się w widoku pulpitu.",
  ...
  memoryPage: {
    ...
    engine: {
      ...
      off: "Wyłączone",
      autoHint:
        "Żaden silnik nie jest przypięty w konfiguracji, więc slot korzysta z domyślnego właściciela.",
    ...
    addons: {
      title: "Dodatki",
      description:
        "Te wtyczki nakładają się na silnik zamiast rywalizować o slot, więc dowolna kombinacja może działać jednocześnie.",
      activeMemory: {
    ...
    dreaming: {
      intro:
        "Śnienie działa jako jedno zarządzane zadanie cron we wszystkich przestrzeniach roboczych agentów, więc te ustawienia są globalne. Należą one do wtyczki {plugin}.",
      schedule: {
        title: "Harmonogram",
        description: "Kiedy uruchamia się pełne przeszukiwanie i który model je narratuje.",
      },
      frequency: {
        label: "Częstotliwość śnienia",
        help: "Rytm cron dla pełnego cyklu marzeń sennych (lekki, REM, następnie głęboki). Pozostaw puste, aby użyć domyślnej wartości wtyczki.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Strefa czasowa",
        help: "Strefa czasowa IANA używana do interpretacji rytmu cron.",
        placeholder: "Europe/Vienna",
      },
      model: {
        label: "Model marzeń sennych",
        help: "Nadpisanie dostawcy/modelu dla narracji dziennika snów. Wymaga zezwolenia na nadpisania modeli subagentów.",
        placeholder: "anthropic/claude-sonnet-4-6",
      },
      verboseLogging: {
        label: "Szczegółowe logowanie",
        help: "Szczegółowo rejestruj każdą fazę marzeń sennych. Przydatne przy dostrajaniu progów.",
      },
      storage: {
        title: "Przechowywanie",
        description: "Gdzie zapisywane są promowane wspomnienia i raporty marzeń sennych.",
        modeLabel: "Tryb przechowywania",
        modeHelp: "Inline zapisuje do pliku pamięci; separate używa dedykowanego pliku raportu.",
        modes: {
          inline: "Inline",
          separate: "Osobno",
          both: "Oba",
        ...
        separateReportsHelp: "Przechowuj raporty marzeń sennych poza głównym plikiem pamięci.",
      },
      phases: {
        light: {
          title: "Faza lekka",
          description:
            "Tani przebieg ostatniej aktywności, który przygotowuje kandydatów do powtórki.",
        },
        deep: {
          title: "Faza głęboka",
          description:
            "Przebieg z oceną promocji, który przenosi krótkoterminowe wpisy do pamięci.",
        },
        rem: {
          title: "Faza REM",
          description:
            "Przebieg wzorców, który wyszukuje powtarzające się motywy w oknie wstecznym.",
        },
      },
      phaseFields: {
        enabled: "Włączone",
        enabledHelp: "Uruchom tę fazę podczas przebiegu.",
        lookbackDays: "Dni wstecz",
        lookbackDaysHelp:
          "Jak daleko wstecz czyta ta faza. Pozostaw puste, aby użyć wartości domyślnej wtyczki.",
        limit: "Limit",
        limitHelp: "Maksymalna liczba wpisów przetwarzanych przez tę fazę na jeden przebieg.",
        ...
        minScoreHelp: "Wynik promocji, jaki musi osiągnąć wpis.",
        minRecallCount: "Minimalna liczba przywołań",
        minRecallCountHelp:
          "Jak często wpis musi zostać przywołany, zanim będzie mógł zostać promowany.",
        minUniqueQueries: "Minimalna liczba unikalnych zapytań",
        minUniqueQueriesHelp: "Ile odrębnych zapytań musiało wyświetlić wpis.",
        recencyHalfLifeDays: "Okres półtrwania świeżości (dni)",
        recencyHalfLifeDaysHelp: "Jak szybko starsze sygnały przywołań tracą na wadze.",
        maxAgeDays: "Maksymalny wiek (dni)",
        maxAgeDaysHelp: "Ignoruj wpisy krótkoterminowe starsze niż to.",
        maxPromotedSnippetTokens: "Maks. tokenów promowanego fragmentu",
        maxPromotedSnippetTokensHelp:
          "Budżet tokenów dla każdego promowanego fragmentu. Informacje o pochodzeniu pozostają dołączone.",
      ...
      unsupported: {
        ...
        description:
          "Wtyczka {plugin} zajmuje slot pamięci, a jej schemat konfiguracji nie ma sekcji śnienia, więc tych ustawień nie można zapisać. Przełącz silnik na karcie Przegląd, aby je edytować.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Utrzymuj widoczny ograniczony katalog narzędzi i odłóż resztę za wyszukiwarkę, aby duże katalogi MCP i wtyczek przestały zapełniać prompt.",
    },
    localModelLean: {
    ...
    auditMessages: {
      ...
      description:
        "Zapisuj metadane bez treści dla bezpośrednich rozmów w rejestrze audytu. Treść wiadomości nigdy nie jest przechowywana.",
    },
  },
  aboutPage: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Nocne przemiatanie śnienia będzie uruchamiane w każdej skonfigurowanej przestrzeni roboczej agenta, przenosząc krótkoterminowe wspomnienia do pamięci długoterminowej. Obowiązuje natychmiast.",
      enableConfirm: "Włącz śnienie",
      disableTitle: "Wyłącz śnienie dla wszystkich agentów",
      disableDetail:
        "Nocne przemiatanie śnienia zostanie zatrzymane dla każdego skonfigurowanego agenta, nie tylko dla tego. Zapisane już wspomnienia pozostają; nic nowego nie jest przenoszone. Obowiązuje natychmiast.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Pozostają wyniki wyszukiwania. Użyj dłuższego prefiksu id.",
    },
    sessionSharing: {
