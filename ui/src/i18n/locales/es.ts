...
export const es: TranslationMap = {
  ...
  dashboardsPage: {
    emptyTitle: "Aún no hay dashboards",
    emptyDescription: "Abre un hilo y cambia a la cara de Dashboard para añadirlo aquí.",
    loadError: "No se pudieron cargar los dashboards: {error}",
  },
  sessionsView: {
  ...
  subtitles: {
    ...
    dashboards: "Hilos que se abren en su cara de dashboard.",
    ...
    memory: "Motor de memoria, backend, búsqueda y dreaming.",
  ...
  memoryPage: {
    ...
    engine: {
      title: "Motor",
      description:
        "Exactamente un plugin de memoria posee el slot de memoria. Seleccionar un motor lo habilita y deshabilita los demás.",
      rowTitle: "Motor de memoria",
      off: "Desactivada",
      autoHint:
        "No hay ningún motor fijado en la configuración, así que el slot recurre a su propietario predeterminado.",
    ...
    backend: {
      ...
      builtin: "Integrado",
      qmd: "QMD",
      builtinHint: "Los archivos de memoria son indexados y buscados por OpenClaw mismo.",
    ...
    import: {
      title: "Importar",
      description: "Trae memoria existente de otros asistentes a un espacio de trabajo de agente.",
    ...
    dreaming: {
      intro:
        "El soñar se ejecuta como un único trabajo cron gestionado en todos los espacios de trabajo de agentes, por lo que estos ajustes son globales. Son propiedad del plugin {plugin}.",
      schedule: {
        title: "Programación",
      ...
      frequency: {
        ...
        help: "Cadencia cron para el barrido completo de sueño (ligero, REM y luego profundo). Déjalo vacío para usar el valor predeterminado del plugin.",
        placeholder: "0 3 * * *",
      },
      timezone: {
        label: "Zona horaria",
      ...
      verboseLogging: {
        ...
        help: "Registra cada fase de sueño en detalle. Útil para ajustar umbrales.",
      },
      storage: {
        title: "Almacenamiento",
        description: "Dónde se escriben las memorias promovidas y los informes de sueño.",
        modeLabel: "Modo de almacenamiento",
        modeHelp:
          "En línea escribe en el archivo de memoria; separado mantiene un archivo de informe dedicado.",
        modes: {
          inline: "En línea",
          separate: "Separado",
          both: "Ambos",
      ...
      phases: {
        light: {
          title: "Fase ligera",
          description:
            "Pasada económica de actividad reciente que prepara candidatos para reproducción.",
        },
        deep: {
          title: "Fase profunda",
          description: "Pasada de promoción puntuada que gradúa entradas de corto plazo a memoria.",
        },
        rem: {
          title: "Fase REM",
          description:
      ...
      phaseFields: {
        ...
        lookbackDaysHelp:
          "Hasta dónde lee esta fase hacia atrás. Deja vacío para usar el valor predeterminado del plugin.",
        limit: "Límite",
        limitHelp: "Máximo de entradas que esta fase procesa por ejecución.",
        ...
        minRecallCountHelp:
          "Con qué frecuencia debe recuperarse una entrada antes de poder promoverse.",
        ...
        recencyHalfLifeDaysHelp:
          "Con qué rapidez pierden peso las señales de recuperación más antiguas.",
        maxAgeDays: "Edad máxima (días)",
        maxAgeDaysHelp: "Ignorar las entradas de corto plazo más antiguas que esto.",
        maxPromotedSnippetTokens: "Máximo de tokens por fragmento promovido",
      ...
      agentScope: {
        ...
        description:
          "Los ajustes anteriores son globales. El diario de sueños, los recuentos de corto plazo y las acciones de mantenimiento a continuación pertenecen a un agente.",
        rowTitle: "Agente",
      },
      unsupported: {
        title: "Ajustes de sueños",
        rowTitle: "No disponible para este motor",
        description:
          "El plugin {plugin} posee el espacio de memoria y su esquema de configuración no tiene una sección de sueños, por lo que estos ajustes no se pueden almacenar. Cambia el motor en la pestaña Resumen para editarlos.",
      },
    },
  },
  sessionsPage: {
  ...
  labsPage: {
    ...
    toolSearch: {
      ...
      description:
        "Mantén visible un directorio de herramientas acotado y difiere el resto tras la búsqueda, para que los grandes catálogos de MCP y plugins dejen de saturar el prompt.",
    },
    localModelLean: {
      title: "Herramientas ligeras para modelos locales",
      description:
        "Descarta las herramientas predeterminadas pesadas que los modelos locales más pequeños manejan mal, dejando un conjunto más reducido que pueden usar de forma fiable.",
    },
    auditMessages: {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Los sueños son un ajuste global; no están limitados a este agente.",
      enableTitle: "Activar Sueños para todos los agentes",
      enableDetail:
        "El barrido nocturno de sueños se ejecutará en todos los espacios de trabajo de agentes configurados, promoviendo recuerdos a corto plazo a la memoria a largo plazo. Esto se aplica de inmediato.",
      enableConfirm: "Activar Sueños",
      disableTitle: "Desactivar Sueños para todos los agentes",
      disableDetail:
        "El barrido nocturno de sueños se detendrá para todos los agentes configurados, no solo para este. Los recuerdos ya escritos se conservan; no se promueve nada nuevo. Esto se aplica de inmediato.",
      disableConfirm: "Desactivar Sueños",
      saving: "Guardando…",
